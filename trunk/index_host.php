...
define('APP_DOMAIN', 'https://socialnetshop.com/apps/apps-store');//Khong co dau /
define('FB_APP_DOMAIN', 'https://apps.facebook.com/apps-store');

define('ROOT_DOMAIN', FB_APP_DOMAIN);
define('APP_ID', '375300019281029');
